...
apk_installable="$repo_root/dist/Compass-0.28.11-debug-installabile.apk"
...
echo "Follow docs/phases/android-0.28.11-voice-default-map-stop-policy-acceptance.md"
