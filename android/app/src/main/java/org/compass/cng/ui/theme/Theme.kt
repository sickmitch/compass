...
internal val CompassDarkColors = darkColorScheme(
    ...
    surfaceVariant = Color(0xFF303531),
    onSurfaceVariant = Color(0xFFBFC9C2),
    outline = Color(0xFF89938C),
    outlineVariant = Color(0xFF303531),
    surfaceDim = Color.Black,
    surfaceBright = Color(0xFF292E2B),
    surfaceContainerLowest = Color.Black,
    surfaceContainerLow = Color(0xFF080A09),
    surfaceContainer = Color(0xFF101311),
    surfaceContainerHigh = Color(0xFF171B18),
    surfaceContainerHighest = Color(0xFF202522),
